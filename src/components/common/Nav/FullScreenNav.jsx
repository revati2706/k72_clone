...
const FullScreenNav = ({onClose}) => {
  ...
  return (
    <div className=
        "fixed top-0 left-0 h-screen w-screen bg-black transform transition-transform duration-500 ease-in-out z-50 " >
      ...
      <div className="w-full h-[120px] flex justify-between   ">
        <div className="flex items-start  m-2 ">
         <svg className=' text-white ' fill='currentColor' xmlns="http://www.w3.org/2000/svg" width="103" height="44" viewBox="0 0 103 44">
        ...
        <button
         onClick={onClose}
          className="relative  h-auto w-auto mr-15 flex items-center justify-center cursor-pointer p-2 hover:text-[#bfe95e]" >
          <span className="absolute block h-36 w-0.5 bg-white rotate-45" />
          <span className="absolute block h-36 w-0.5 bg-white -rotate-45" />
        </button>
      </div>
