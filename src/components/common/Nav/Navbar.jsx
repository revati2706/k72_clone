...
const Navbar = ({logoColor="white"}) => {
 ...
 switch (logoColor) {
  ...
  return (
    <div >
        <div className=' z-50 w-full flex justify-between bg-transparent fixed'>
            <div className=''>
                <svg className={`${lgclr} m-2`} fill='currentColor' xmlns="http://www.w3.org/2000/svg" width="103" height="44" viewBox="0 0 103 44">
            ...
            <div
             ...
             className='relative  h-[50px] w-[270px] overflow-hidden group'>
             <div className='absolute inset-0 bg-[#bfff57] -translate-y-full group-hover:translate-y-0 transition-transform duration-200 '></div>
             <div className='bg-black flex flex-col p-5 gap-1 justify-center items-end h-full w-full '>
          <span className='black z-10 w-[3vw]  h-0.5 bg-white'></span>
          <span className='black z-10 w-[1.5vw] h-0.5 bg-white'></span>
        </div>
       </div>
